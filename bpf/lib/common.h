...
#define ENDPOINT_F_MULTI_NIC_L2 2	/* Special endpoint representing multi nic that is not a veth */
#define ENDPOINT_F_MULTI_NIC_VETH 4 /* Special endpoint representing multi nic of type veth */
