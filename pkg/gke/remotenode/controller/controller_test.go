...
func (f *fakeWgAgent) NodeAdd(newNode nodeTypes.Node) error {
	return nil
}

func (f *fakeWgAgent) NodeUpdate(oldNode, newNode nodeTypes.Node) error {
	return nil
}

func (f *fakeWgAgent) NodeDelete(node nodeTypes.Node) error {
	return nil
}

func (f *fakeWgAgent) NodeValidateImplementation(node nodeTypes.Node) error {
	return nil
}

func (f *fakeWgAgent) NodeConfigurationChanged(config datapath.LocalNodeConfiguration) error {
	return nil
}
